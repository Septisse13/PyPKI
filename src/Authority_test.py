...
signKeyStorage = FileStorage.FileStorage("../test/private")
...
caCertStorage = FileStorage.FileStorage("../test/cacert")
...
certStorage = FileStorage.FileStorage("../test/cert")
...
childTemplateStorage = FileStorage.FileStorage("../test/template")
